...
def isolated_settings(tmp_path, monkeypatch):
    ...
    # meta.md needs no isolation: it is tracked in the repo, and settings.write()
    # refuses it outright, so nothing in the suite can reach it. Tests read the
    # real file, which is what a session reads.
